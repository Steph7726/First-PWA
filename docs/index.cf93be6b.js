 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o0{constructor(e){this._byteString=e}static fromBase64String(e){try{return new o0(rT.fromBase64String(e))}catch(e){throw new tX(tW.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new o0(rT.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o1{constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new tX(tW.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ri(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o6{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new tX(tW.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new tX(tW.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return t4(this._lat,e._lat)||t4(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o5{constructor(e){this._values=(e||[]).map(e=>e)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(e,t){if(e.length!==t.length)return!1;for(let r=0;r<e.length;++r)if(e[r]!==t[r])return!1;return!0}(this._values,e._values)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o3=/^__.*__$/;class o8{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return null!==this.fieldMask?new nW(e,this.data,this.fieldMask,t,this.fieldTransforms):new nQ(e,this.data,t,this.fieldTransforms)}}function o4(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw tQ()}}class o7{constructor(e,t,r,n,i,s){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=n,void 0===i&&this.Fu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Mu(){return this.settings.Mu}xu(e){return new o7(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Ou(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.xu({path:r,Nu:!1});return n.Bu(e),n}Lu(e){var t;let r=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.xu({path:r,Nu:!1});return n.Fu(),n}ku(e){return this.xu({path:void 0,Nu:!0})}qu(e){return ai(e,this.settings.methodName,this.settings.Qu||!1,this.path,this.settings.Ku)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Fu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Bu(this.path.get(e))}Bu(e){if(0===e.length)throw this.qu("Document fields must not be empty");if(o4(this.Mu)&&o3.test(e))throw this.qu('Document fields cannot begin and end with "__"')}}class o9{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||sg(e)}$u(e,t,r,n=!1){return new o7({Mu:e,methodName:t,Ku:r,path:ri.emptyPath(),Nu:!1,Qu:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ae(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof t9||e instanceof o6||e instanceof o0||e instanceof oH||e instanceof o2||e instanceof o5)}function at(e,t,r){if(!ae(r)||!("object"==typeof r&&null!==r&&(Object.getPrototypeOf(r)===Object.prototype||null===Object.getPrototypeOf(r)))){let n=oq(r);throw"an object"===n?t.qu(e+" a custom object"):t.qu(e+" "+n)}}const ar=RegExp("[~\\*/\\[\\]]");function an(e,t,r){if(t.search(ar)>=0)throw ai(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,r);try{return new o1(...t.split("."))._internalPath}catch(n){throw ai(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,r)}}function ai(e,t,r,n,i){let s=n&&!n.isEmpty(),o=void 0!==i,a=`Function ${t}() called with invalid data`;r&&(a+=" (via `toFirestore()`)"),a+=". ";let l="";return(s||o)&&(l+=" (found",s&&(l+=` in field ${n}`),o&&(l+=` in document ${i}`),l+=")"),new tX(tW.INVALID_ARGUMENT,a+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ah{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class au extends as{constructor(e,t,r,n,i,s){super(e,t,r,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new ac(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let r=this._document.data.field(aa("DocumentSnapshot.get",e));if(null!==r)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class ac extends au{data(e={}){return super.data(e)}}class af{constructor(e,t,r,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new ah(n.hasPendingWrites,n.fromCache),this.query=r}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new ac(this._firestore,this._userDataWriter,r.key,r,new ah(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new tX(tW.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(r=>{let n=new ac(e._firestore,e._userDataWriter,r.doc.key,r.doc,new ah(e._snapshot.mutatedKeys.has(r.doc.key),e._snapshot.fromCache),e.query.converter);return r.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{let r=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let n=new ac(e._firestore,e._userDataWriter,t.doc.key,t.doc,new ah(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=r.indexOf(t.doc.key),r=r.delete(t.doc.key)),1!==t.type&&(s=(r=r.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return tQ()}}(t.type),doc:n,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}class ad extends al{constructor(e){super(),this.firestore=e}convertBytes(e){return new o0(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new oH(this.firestore,null,t)}}function ap(e,t){return function(e,t){let r=new tY;return e.asyncQueue.enqueueAndForget(async()=>oc(await oM(e).then(e=>e.syncEngine),t,r)),r.promise}(oZ(e),t)}new WeakMap,function(e=!0){tj="11.2.0",eq(new eh("firestore",(t,{instanceIdentifier:r,options:n})=>{let i=t.getProvider("app").getImmediate(),s=new oJ(new t1(t.getProvider("auth-internal")),new t3(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new tX(tW.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rR(e.options.projectId,t)}(i,r),i);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),eK(tV,"4.7.6",void 0),eK(tV,"4.7.6","esm2017")}();const ag=function(e,t){let r=(function(e,t){let r=e.container.getProvider("heartbeat").getImmediate({optional:!0});return r&&r.triggerHeartbeat(),e.container.getProvider(t)})("object"==typeof e?e:function(e=eP){let t=eB.get(e);if(!t&&e===eP&&et())return eG();if(!t)throw ez.create("no-app",{appName:e});return t}(),"firestore").getImmediate({identifier:"string"==typeof e?e:"(default)"});if(!r._initialized){let e=ee("firestore");e&&function(e,t,r,n={}){var i;let s=(e=oz(e,oG))._getSettings(),o=`${t}:${r}`;if("firestore.googleapis.com"!==s.host&&s.host!==o&&tK("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},s),{host:o,ssl:!1})),n.mockUserToken){let t,r;if("string"==typeof n.mockUserToken)t=n.mockUserToken,r=tF.MOCK_USER;else{t=function(e,t){if(e.uid)throw Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let r=t||"demo-project",n=e.iat||0,i=e.sub||e.user_id;if(!i)throw Error("mockUserToken must contain 'sub' or 'user_id' field!");let s=Object.assign({iss:`https://securetoken.google.com/${r}`,aud:r,iat:n,exp:n+3600,auth_time:n,sub:i,user_id:i,firebase:{sign_in_provider:"custom",identities:{}}},e);return[H(JSON.stringify({alg:"none",type:"JWT"})),H(JSON.stringify(s)),""].join(".")}(n.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);let s=n.mockUserToken.sub||n.mockUserToken.user_id;if(!s)throw new tX(tW.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");r=new tF(s)}e._authCredentials=new t0(new tJ(t,r))}}(r,...e)}return r}(eG({apiKey:"AIzaSyA3v10UFzZ_HGbIIJwItHDiCdnZPBjnbZ8",authDomain:"first-pwa-fd641.firebaseapp.com",projectId:"first-pwa-fd641",storageBucket:"first-pwa-fd641.firebasestorage.app",messagingSenderId:"1026685908541",appId:"1:1026685908541:web:1f145ccf10a80e7f295c54",measurementId:"G-E55YXDLFSV"})),am=document.getElementById("taskInput"),ay=document.getElementById("addTaskBtn"),av=document.getElementById("taskList");async function aw(e){await function(e,t){var r;let n=oz(e.firestore,oJ),i=oX(e),s=(r=e.converter)?r.toFirestore(t):t;return ap(n,[(function(e,t,r,n,i,s={}){let o,a;let l=e.$u(2*(!!s.merge||!!s.mergeFields),t,r,i);at("Data must be an object, but it was:",l,n);let h=function e(t,r){let n={};return rg(t)?r.path&&r.path.length>0&&r.fieldMask.push(r.path):rp(t,(t,i)=>{let s=function t(r,n){if(ae(r=el(r)))return at("Unsupported field value:",n,r),e(r,n);if(r instanceof o2)return function(e,t){if(!o4(t.Mu))throw t.qu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.qu(`${e._methodName}() is not currently supported inside arrays`);let r=e._toFieldTransform(t);r&&t.fieldTransforms.push(r)}(r,n),null;if(void 0===r&&n.ignoreUndefinedProperties)return null;if(n.path&&n.fieldMask.push(n.path),r instanceof Array){if(n.settings.Nu&&4!==n.Mu)throw n.qu("Nested arrays are not supported");return function(e,r){let n=[],i=0;for(let s of e){let e=t(s,r.ku(i));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),i++}return{arrayValue:{values:n}}}(r,n)}return function(e,t){var r,n,i;if(null===(e=el(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return r=t.serializer,"number"==typeof(i=n=e)&&Number.isInteger(i)&&!rf(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER?nk(n):nD(r,n);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let r=t9.fromDate(e);return{timestampValue:iy(t.serializer,r)}}if(e instanceof t9){let r=new t9(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:iy(t.serializer,r)}}if(e instanceof o6)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof o0)return{bytesValue:iv(t.serializer,e._byteString)};if(e instanceof oH){let r=t.databaseId,n=e.firestore._databaseId;if(!n.isEqual(r))throw t.qu(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);return{referenceValue:ib(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof o5)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.qu("VectorValues must only contain numeric values.");return nD(t.serializer,e)})}}}}};throw t.qu(`Unsupported field value: ${oq(e)}`)}(r,n)}(i,r.Ou(t));null!=s&&(n[t]=s)}),{mapValue:{fields:n}}}(n,l);if(s.merge)o=new rE(l.fieldMask),a=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=function(e,t,r){if((t=el(t))instanceof o1)return t._internalPath;if("string"==typeof t)return an(e,t);throw ai("Field path arguments must be of type string or ",e,!1,void 0,r)}(t,n,r);if(!l.contains(i))throw new tX(tW.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}o=new rE(e),a=l.fieldTransforms.filter(e=>o.covers(e.field))}else o=null,a=l.fieldTransforms;return new o8(new rW(h),o,a)})(function(e){let t=e._freezeSettings(),r=sg(e._databaseId);return new o9(e._databaseId,!!t.ignoreUndefinedProperties,r)}(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,nq.exists(!1))]).then(()=>i)}(oW(ag,"todos"),{text:e,completed:!1})}async function ab(){var e=await aE();av.innerHTML="",e.forEach(e=>{if(!e.data().completed){let t=document.createElement("li");t.id=e.id,t.textContent=e.data().text,av.appendChild(t)}})}async function aE(){var e=await function(e){e=oz(e,oK);let t=oz(e.firestore,oJ),r=oZ(t),n=new ad(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new tX(tW.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new tY;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new ok({next:r=>{s.eu(),t.enqueueAndForget(()=>s5(e,o)),r.fromCache&&"server"===n.source?i.reject(new tX(tW.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),o=new s7(r,s,{includeMetadataChanges:!0,ua:!0});return s6(e,o)})(await oP(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new af(t,n,e,r)))}(oW(ag,"todos"));let t=[];return e.forEach(e=>{t.push(e)}),t}async function a_(e){let t=oX(ag,"todos",e);await ap(oz(t.firestore,oJ),[new nZ(t._key,nq.none())])}ay.addEventListener("click",async()=>{let e=am.value.trim();if(e){let t=function(e){let t=document.createElement("div");return t.textContent=e,t.innerHTML}(e);await aw(t),ab(),am.value=""}}),av.addEventListener("click",async e=>{if("LI"===e.target.tagName){let t=e.target.id;await a_(t),e.target.remove()}});var aT={};aT=new URL("service-worker.fb6437dc.js",import.meta.url).toString();const aI=new URL(aT);"serviceWorker"in navigator&&navigator.serviceWorker.register(aI.href,{scope:"/First-PWA/"}).then(e=>console.log("Service Worker Registered for scope:",aI.href,"with","file:///app.js")).catch(e=>console.error("Service Worker Error:",e));
//# sourceMappingURL=index.cf93be6b.js.map
